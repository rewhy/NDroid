...
#include "DroidScope/linuxAPI/Context.h"
#include "DroidScope/taintTracker/trace.h"
...
/*new  added  */
#ifdef TARGET_ARM
void art_wait_uid(Monitor* mon, target_ulong uid)
{
    wait_uid(mon,uid);
}
void stop_art_trace(Monitor *mon)
{
    stop_trace(mon);
}
#endif
